    ...
    <Tooltip delayDuration={300}>
      ...
      <TooltipContent className="max-w-xs text-xs p-3 bg-muted text-muted-foreground">
        ...
        <ul className="list-disc pl-4 space-y-1">
          ...
          <li>Use <span className="font-mono text-chart-3">-term</span> to exclude results (e.g. <span className="font-mono text-chart-3">-leather</span> excludes leather items)</li>

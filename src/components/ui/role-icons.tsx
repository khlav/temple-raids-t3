...
export function RoleIconTank({ size = 16, className }: RoleIconProps) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} className={className} aria-label="Tank">
      <path
...
export function RoleIconHealer({ size = 16, className }: RoleIconProps) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} className={className} aria-label="Healer">
      <rect x="10" y="4" width="4" height="16" fill="#00FF00" stroke="#006600" strokeWidth="0.5" />
      <rect x="4" y="10" width="16" height="4" fill="#00FF00" stroke="#006600" strokeWidth="0.5" />
    </svg>
  );
}
...
export function RoleIconDPS({ size = 16, className }: RoleIconProps) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} className={className} aria-label="DPS">
      {/* Left sword */}
      <path
 ...
 */
export const ROLE_ICON_MAP: Record<string, React.ComponentType<RoleIconProps>> = {
  "{tank}": RoleIconTank,
 ...
 */
export function getRoleIcon(code: string): React.ComponentType<RoleIconProps> | null {
